...
func (m *MockProposalTxVerifier) ProcessProposalVerifyTx(txBz []byte) (types0.Tx, uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockTxSelector) SelectTxForProposal(ctx context.Context, maxTxBytes, maxBlockGas uint64, memTx types0.Tx, txBz []byte, gasWanted uint64) bool {
	m.ctrl.T.Helper()
